...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params['W2'] = np.random.normal(scale=weight_scale, size=(num_filters*int(input_dim[1]*input_dim[2]*0.25) , hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        scores, final_cache = affine_forward(out2, W3, b3)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dout, grads['W3'], grads['b3'] = affine_backward(dout, final_cache)
